...
1. **Is there a leak?** (detection)
2. **Where is the leak?** (localization)
3. **Which repair crew should be sent, and by what route?** (dispatch)
...
- **notebooks/** — where I write and run the code, step by step.
- **data/** — the simulated sensor readings I create.
- **results/** — the charts and outputs (like the leak-drop chart).
- **src/** — any extra Python scripts I add later.
